<x-guest-layout>
    ...
    <div class="bg-l-blue pt-10 pb-5 w-full  -mt-20" style="">
        ...
        <h1 class="text-center font-extrabold text-4xl mt-16">CHEMICAL ENGINEERING</h1>
        <h1 class="text-center font-extrabold text-4xl mb-2">CHALLENGE & COMPETITION 2022</h1>
