...
<div class="flex-1 flex flex-col min-h-0 bg-gray-800">
  ...
  <path stroke-linecap="round" stroke-linej.oin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15M12 9l-3 3m0 0l3 3m-3-3h12.75" />
      ...
      @endguest
      @auth
      <a href="{{route('penyisihan')}}" class="mb-5 @if(Route::current()->getName()=="penyisihan")bg-gray-900 text-white @else text-gray-300 bg-gray-800 @endif  group hover:bg-gray-700 flex items-center px-2 py-2 text-sm font-medium rounded-md">
        <!--
          Heroicon name: outline/home
        ...
        <span class="flex-1">Babak Penyisihan </span>
      </a>
      ...
      <a href="{{route('admin')}}" class="mb-5 @if(Route::current()->getName()=="tryout")bg-gray-900 text-white @else text-gray-300 bg-gray-800 @endif  group hover:bg-gray-700 flex items-center px-2 py-2 text-sm font-medium rounded-md">
        ...
        <span class="flex-1"> Panel Admin Tryout</span>
      </a>
      <a href="{{route('admin2')}}" class="mb-10 @if(Route::current()->getName()=="tryout")bg-gray-900 text-white @else text-gray-300 bg-gray-800 @endif  group hover:bg-gray-700 flex items-center px-2 py-2 text-sm font-medium rounded-md">
        <!--
          Heroicon name: outline/home
        ...
        <span class="flex-1"> Panel Admin Penyisihan </span>
      </a>
      @endif
      @endauth
