                ...
                <div class="col-span-7 lg:col-span-5 p-5 rounded-md bg-white ">
                    <div class="flex">
                        ...
                        <div class="text-2xl mt-2 ml-2 ">
                            <div class="soal">
                                <img class="w-full" style="max-width:600px" src="{{ $soal->image }}">
                                {{ $soal->soal }}
                            </div>
                            <form id="myForm" action="{{ route('answer') }}" method="POST">
                                @csrf
                                ...
                                <div class="jawaban mt-5">
                                    <div class="flex items-center mb-2">
                                        <input
                                            @if (Auth::user()->answers->where('soal', $soal->id)->first() != null) @if (Auth::user()->answers->where('soal', $soal->id)->first()->jawaban == 'a') checked @endif
                                        ...
                                        <label for="default-radio-1"
                                            ...
                                            <img src="{{$soal->a}}" class="inline-block" alt="">
                                            @else
                                            <span>
                                            {{
                                                $soal->a
                                    ...
                                    <div class="flex items-center mb-2">
                                        <input
                                            @if (Auth::user()->answers->where('soal', $soal->id)->first() != null) @if (Auth::user()->answers->where('soal', $soal->id)->first()->jawaban == 'b') checked @endif
                                        ...
                                        <label for="default-radio-2"
                                            ...
                                            <img src="{{$soal->b}}" class="inline-block" alt="">
                                            @else
                                            {{
                                                $soal->b
                                                }}
                                    ...
                                    <div class="flex items-center mb-2">
                                        <input
                                            @if (Auth::user()->answers->where('soal', $soal->id)->first() != null) @if (Auth::user()->answers->where('soal', $soal->id)->first()->jawaban == 'c') checked @endif
                                        ...
                                        <img src="{{$soal->c}}" class="inline-block" alt="">
                                        @else
                                        {{
                                            $soal->c
                                            }}
                                    ...
                                    <div class="flex items-center mb-2">
                                        <input
                                            @if (Auth::user()->answers->where('soal', $soal->id)->first() != null) @if (Auth::user()->answers->where('soal', $soal->id)->first()->jawaban == 'd') checked @endif
                                        ...
                                        <label for="default-radio-4"
                                            ...
                                            <img src="{{$soal->d}}" class="inline-block" alt="">
                                            @else
                                            {{
                                                $soal->d
                                                }}
                                    ...
                                    <div class="flex items-center">
                                        <input
                                            @if (Auth::user()->answers->where('soal', $soal->id)->first() != null) @if (Auth::user()->answers->where('soal', $soal->id)->first()->jawaban == 'e') checked @endif
                                        ...
                                        <img src="{{$soal->e}}" class="inline-block" alt="">
                                        @else
                                        {{
                                            $soal->e
                                            }}
                ...
                <div class="col-span-7 lg:col-span-2 ">
                    <div class="rounded-md bg-l-blue p-5">
                        ...
                        <div style="cursor:pointer;" class="grid-cols-6 grid gap-3 mt-5">
                            ...
                            @if (Auth::user()->answers->where('soal', $s->id)->first() == null or Auth::user()->answers->where('soal', $s->id)->first()->jawaban == null and $s->nomor != $soal->nomo) 
                            bg-white 
                            hover:bg-gray-200
                            @endif
                ...
                <div class="grid grid-cols-3 col-span-7 lg:col-span-5 text-white font-bold text-2xl">
                    ...
                    <div class="text-center text-2xl">
                        <div class="flex items-center " style="justify-content: center">
                            <input id="default-checkbox" @if(Auth::user()->answers->where('soal', $soal->id)->first() != null) @if (Auth::user()->answers->where('soal', $soal->id)->first()->ragu == 1) checked @endif @endif name="ragu" type="checkbox" value="1"
...
<script>
  ...
  return hours + ":" + minutes + ":" + seconds;
    ...
    var startDateTime = '{{Auth::user()->start_tryout}}';
    var endDateTime = '{{Auth::user()->end_tryout}}';
