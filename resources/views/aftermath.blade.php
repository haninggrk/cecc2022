<x-guest-layout>
    ...
    <div class="bg-l-blue pt-10 pb-5 w-full  -mt-20" style="">
        ...
        <div class="mt-12 text-center">
            <h1 style="color: #175E88
            " class="text-center font-extrabold text-4xl mb-2">Terima kasih karena telah mengerjakan</h1>
            <h1 style="color: #175E88
            " class="text-center text-d-blue font-extrabold text-4xl mb-2">soal dengan baik dan jujur</h1>
        </div>
        <div class="mt-12 text-center">
            <a href="{{route('home')}}"><button class="text-center text-4xl font-bold p-5 text-white rounded-xl bg-blue-700 hover:bg-blue-800 ">Klik untuk kembali ke home</button></a>
            </div>
    </div>
    </div>
    <div class="bg-l-blue">
